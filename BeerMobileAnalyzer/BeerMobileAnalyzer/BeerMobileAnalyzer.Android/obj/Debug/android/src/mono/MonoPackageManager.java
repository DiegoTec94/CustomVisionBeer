...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "BeerMobileAnalyzer.Android.dll" comes first in this list. */
		"BeerMobileAnalyzer.Android.dll",
		"BeerMobileAnalyzer.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		...
		"Xam.Plugins.ImageCropper.Droid.dll",
